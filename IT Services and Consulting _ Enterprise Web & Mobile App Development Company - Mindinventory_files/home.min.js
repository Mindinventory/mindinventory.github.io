/* Jquery Selection */
(function($){$.fn.sectionsnap=function(options){var settings=$.extend({'delay':100,'selector':".section",'reference':.9,'animationTime':400,'offsetTop':0,'offsetBottom':0},options);var $wrapper=this,direction='down',currentScrollTop=$(window).scrollTop(),scrollTimer,animating=!1;var updateDirection=function(){if($(window).scrollTop()>=currentScrollTop)
    direction='down';else direction='up';currentScrollTop=$(window).scrollTop()}
    var getClosestElement=function(){var $list=$wrapper.find(settings.selector),wt=$(window).scrollTop(),wh=$(window).height(),refY=wh*settings.reference,wtd=wt+refY-1,$target;if(direction=='down'){$list.each(function(){var st=$(this).position().top;if((st>wt)&&(st<=wtd)){$target=$(this);return!1}})}else{wtd=wt-refY+1;$list.each(function(){var st=$(this).position().top;if((st<wt)&&(st>=wtd)){$target=$(this);return!1}})}
        return $target}
    var snap=function(){var $target=getClosestElement();if($target){$('.success-story-item').removeClass('active');$($target).addClass('active');var activeIndicat=$('.success-story-item.active').attr('data-indicate');$('.success-screens-item').removeClass('active');$('.success-stories-indicator ul li').removeClass('active');$('.'+activeIndicat).addClass('active');animating=!0;$('html, body').animate({scrollTop:($target.offset().top)},settings.animationTime,function(){window.clearTimeout(scrollTimer);animating=!1})}}
...
/* Intro carousel */
$(document).ready(function(){function restartanim(){circleIOS.animate({transform:"s0 0"},0,mina.easein),circleMaskVisibleios.animate({transform:"s0 0"},0,mina.easein),circleANDROID.animate({transform:"s0 0"},0,mina.easein),circleMaskVisibleAndroid.animate({transform:"s0 0"},0,mina.easein),circleIONIC.animate({transform:"s0 0"},0,mina.easein),circleMaskVisibleIonic.animate({transform:"s0 0"},0,mina.easein),circleANGULAR.animate({transform:"s0 0"},0,mina.easein),circleMaskVisibleAngular.animate({transform:"s0 0"},0,mina.easein),circleNODE.animate({transform:"s0 0"},0,mina.easein),circleMaskVisibleNode.animate({transform:"s0 0"},0,mina.easein),circlePHONEGAP.animate({transform:"s0 0"},0,mina.easein),circleMaskVisiblePhonegap.animate({transform:"s0 0"},0,mina.easein),circleHTML.animate({transform:"s0 0"},0,mina.easein),circleMaskVisibleHTML.animate({transform:"s0 0"},0,mina.easein),setTimeout(function(){anim1()},100)}
    var s=Snap("#services-mi");s.attr({opacity:1}),circleIOS=s.select(".hide-ios-circle"),circleIOS.attr({transform:"s0 0",fill:"#ffffff"}),circleANDROID=s.select(".hide-android-circle"),circleANDROID.attr({transform:"s0 0",fill:"#ffffff"}),circleIONIC=s.select(".hide-ionic-circle"),circleIONIC.attr({transform:"s0 0",fill:"#ffffff"}),circleANGULAR=s.select(".hide-angular-circle"),circleANGULAR.attr({transform:"s0 0",fill:"#ffffff"}),circleNODE=s.select(".hide-node-circle"),circleNODE.attr({transform:"s0 0",fill:"#ffffff"}),circlePHONEGAP=s.select(".hide-phonegap-circle"),circlePHONEGAP.attr({transform:"s0 0",fill:"#ffffff"}),circleHTML=s.select(".hide-html-circle"),circleHTML.attr({transform:"s0 0",fill:"#ffffff"});var circleMaskforVisible=s.circle(312,312,312).attr({fill:"rgba(255, 255, 255, 1)",transform:"s0 0"}),circleMaskVisibleios=circleMaskforVisible.clone(),circleMaskVisibleAndroid=circleMaskforVisible.clone(),circleMaskVisibleIonic=circleMaskforVisible.clone(),circleMaskVisibleAngular=circleMaskforVisible.clone(),circleMaskVisibleNode=circleMaskforVisible.clone(),circleMaskVisiblePhonegap=circleMaskforVisible.clone(),circleMaskVisibleHTML=circleMaskforVisible.clone();ios=s.select("#iOS"),ios.attr({mask:circleMaskVisibleios}),Android=s.select("#Android"),Android.attr({mask:circleMaskVisibleAndroid}),Ionic=s.select("#Ionic"),Ionic.attr({mask:circleMaskVisibleIonic}),Ionic=s.select("#Angular"),Ionic.attr({mask:circleMaskVisibleAngular}),Nodeicon=s.select("#Node"),Nodeicon.attr({mask:circleMaskVisibleNode}),Phonegap=s.select("#Phonegap"),Phonegap.attr({mask:circleMaskVisiblePhonegap}),HTML=s.select("#HTML5"),HTML.attr({mask:circleMaskVisibleHTML});var anim1=function(){circleMaskVisibleios.animate({transform:"s1 1"},1e3,mina.easein,anim2)},anim2=function(){circleIOS.animate({transform:"s1 1"},300,mina.easein,anim3)},anim3=function(){circleMaskVisibleAndroid.animate({transform:"s1 1"},1e3,mina.easein,anim4)},anim4=function(){circleANDROID.animate({transform:"s1 1"},300,mina.easein,anim5)},anim5=function(){circleMaskVisibleIonic.animate({transform:"s1 1"},1e3,mina.easein,anim6)},anim6=function(){circleIONIC.animate({transform:"s1 1"},300,mina.easein,anim7)},anim7=function(){circleMaskVisibleAngular.animate({transform:"s1 1"},1e3,mina.easein,anim8)},anim8=function(){circleANGULAR.animate({transform:"s1 1"},300,mina.easein,anim9)},anim9=function(){circleMaskVisibleNode.animate({transform:"s1 1"},1e3,mina.easein,anim10)},anim10=function(){circleNODE.animate({transform:"s1 1"},300,mina.easein,anim11)},anim11=function(){circleMaskVisiblePhonegap.animate({transform:"s1 1"},1e3,mina.easein,anim12)},anim12=function(){circlePHONEGAP.animate({transform:"s1 1"},300,mina.easein,anim13)},anim13=function(){circleMaskVisibleHTML.animate({transform:"s1 1"},1e3,mina.easein,anim14)},anim14=function(){circleHTML.animate({transform:"s1 1"},300,mina.easein,restartanim)};anim1()});$(document).ready(function(){$.jCanvas.defaults.fromCenter=!1;$('#industriesbanner').addLayer({name:'grid',type:'image',source:'img/industries-banner/grid.png',x:0,y:0}).addLayer({name:'fade-effect',type:'image',source:'img/industries-banner/fade-effect.png',x:0,y:0}).addLayer({name:'cafe',type:'image',source:'img/industries-banner/cafe.png',x:100,y:72,opacity:0}).addLayer({name:'factory',type:'image',source:'img/industries-banner/factory.png',x:100,y:62,opacity:0}).addLayer({name:'restaurent',type:'image',source:'img/industries-banner/restaurent.png',x:100,y:93,opacity:0}).addLayer({name:'school',type:'image',source:'img/industries-banner/school.png',x:100,y:84,opacity:0}).addLayer({name:'hospital',type:'image',source:'img/industries-banner/hospital.png',x:100,y:62,opacity:0}).addLayer({name:'cinema',type:'image',source:'img/industries-banner/cinema.png',x:100,y:64,opacity:0}).drawLayers();function industriesBannerAnim(){$('#industriesbanner').animateLayer('cinema',{opacity:0,x:-100},400,function(layer){$(this).animateLayer('cafe',{opacity:1,x:15},400,function(layer){$(this).animateLayer('cafe',{opacity:1,x:15},1500,function(layer){$(this).animateLayer('cafe',{opacity:0,x:-100},400,function(layer){$(this).animateLayer('cafe',{x:100},10);$(this).animateLayer('factory',{opacity:1,x:0},400,function(layer){$(this).animateLayer('factory',{opacity:1,x:0},1500,function(layer){$(this).animateLayer('factory',{opacity:0,x:-100},400,function(layer){$(this).animateLayer('factory',{x:100},10);$(this).animateLayer('restaurent',{opacity:1,x:0},400,function(layer){$(this).animateLayer('restaurent',{opacity:1,x:0},1500,function(layer){$(this).animateLayer('restaurent',{opacity:0,x:-100},400,function(layer){$(this).animateLayer('restaurent',{x:100},10);$(this).animateLayer('school',{opacity:1,x:0},400,function(layer){$(this).animateLayer('school',{opacity:1,x:0},1500,function(layer){$(this).animateLayer('school',{opacity:0,x:-100},400,function(layer){$(this).animateLayer('school',{x:100},10);$(this).animateLayer('hospital',{opacity:1,x:31},400,function(layer){$(this).animateLayer('hospital',{opacity:1,x:31},1500,function(layer){$(this).animateLayer('hospital',{opacity:0,x:-100},400,function(layer){$(this).animateLayer('hospital',{x:100},10);$(this).animateLayer('cinema',{opacity:1,x:18},400,function(layer){$(this).animateLayer('cinema',{opacity:1,x:18},1500,function(layer){$(this).animateLayer('cinema',{opacity:0,x:100},400,industriesBannerAnim())})})})})})})})})})})})})})})})})})})}
    industriesBannerAnim()})

/* Service */
$(document).ready(function(){$.jCanvas.defaults.fromCenter=!1;$('#mobileservices').addLayer({name:'base',type:'image',source:'img/services/img/mobile-canvas/base.png',x:0,y:227,opacity:0}).addLayer({name:'dottedline',type:'image',source:'img/services/img/mobile-canvas/dotted-lines.png',x:364,y:0,opacity:0}).addLayer({name:'graph',type:'image',source:'img/services/img/mobile-canvas/graph.png',x:-140,y:285,opacity:0}).addLayer({name:'mobiledevice',type:'image',source:'img/services/img/mobile-canvas/mobile-device.png',x:308,y:0,opacity:0}).addLayer({name:'code',type:'image',source:'img/services/img/mobile-canvas/code.png',x:480,y:-60,opacity:0}).addLayer({name:'toggle',type:'image',source:'img/services/img/mobile-canvas/toggle-buttons.png',x:606,y:215,opacity:0}).addLayer({name:'graph1',type:'image',source:'img/services/img/mobile-canvas/graph1.png',x:245,y:0,opacity:0}).addLayer({name:'graph2',type:'image',source:'img/services/img/mobile-canvas/graph2.png',x:203,y:0,opacity:0}).addLayer({name:'graph3',type:'image',source:'img/services/img/mobile-canvas/graph3.png',x:160,y:0,opacity:0}).addLayer({name:'search',type:'image',source:'img/services/img/mobile-canvas/search.png',x:100,y:56,opacity:0}).addLayer({name:'like',type:'image',source:'img/services/img/mobile-canvas/like.png',x:511,y:0,opacity:0}).addLayer({name:'share',type:'image',source:'img/services/img/mobile-canvas/share.png',x:438,y:0,opacity:0}).addLayer({name:'comment',type:'image',source:'img/services/img/mobile-canvas/comment.png',x:367,y:0,opacity:0}).addLayer({name:'gearwheels',type:'image',source:'img/services/img/mobile-canvas/gear-wheels.png',x:437,y:0,opacity:0}).drawLayers();$(window).scroll(function(){if($(window).scrollTop()>$('#mobileservices').offset().top-window.innerHeight/2){$('#mobileservices').animateLayer('base',{y:177,opacity:1,},400,function(layer){$(this).animateLayer('mobiledevice',{y:61,opacity:1,},400,function(layer){$(this).animateLayer('graph',{opacity:1,x:0,y:204},400);$(this).animateLayer('toggle',{opacity:1,x:478,y:286,},400);$(this).animateLayer('code',{y:60,opacity:1,},400,function(layer){$(this).animateLayer('dottedline',{opacity:1,},400);$(this).animateLayer('search',{opacity:1,x:221,},400,function(layer){$(this).animateLayer('graph1',{opacity:1,y:305,},400,function(layer){$(this).animateLayer('graph2',{opacity:1,y:330,},400,function(layer){$(this).animateLayer('graph3',{opacity:1,y:354,},400,function(layer){$(this).animateLayer('like',{opacity:1,y:425,},400,function(layer){$(this).animateLayer('share',{opacity:1,y:464,},400,function(layer){$(this).animateLayer('comment',{opacity:1,y:507,},400)})})})})})})})})})}});$('#webservices').addLayer({type:'image',name:'base',source:'img/services/img/web-canvas/base.png',x:0,y:294,opacity:0}).addLayer({name:'server',type:'image',source:'img/services/img/web-canvas/server.png',x:137,y:340,opacity:0}).addLayer({name:'line2',type:'image',source:'img/services/img/web-canvas/line2.png',x:138,y:178,opacity:0}).addLayer({name:'line3',type:'image',source:'img/services/img/web-canvas/line3.png',x:202,y:68,opacity:0}).addLayer({name:'api',type:'image',source:'img/services/img/web-canvas/api.png',x:97,y:0,opacity:0}).addLayer({name:'computer',type:'image',source:'img/services/img/web-canvas/computer.png',x:137,y:-45,opacity:0}).addLayer({name:'mouse',type:'image',source:'img/services/img/web-canvas/mouse.png',x:752,y:366,opacity:0}).addLayer({name:'keyboard',type:'image',source:'img/services/img/web-canvas/keyboard.png',x:512,y:392,opacity:0}).addLayer({name:'documents',type:'image',source:'img/services/img/web-canvas/documents.png',x:387,y:514,opacity:0}).addLayer({name:'line1',type:'image',source:'img/services/img/web-canvas/line1.png',x:8,y:514,opacity:0}).addLayer({name:'database',type:'image',source:'img/services/img/web-canvas/database.png',x:350,y:562,opacity:0}).addLayer({name:'admin-view',type:'image',source:'img/services/img/web-canvas/admin-view.png',x:-36,y:471,opacity:0}).addLayer({name:'web-view',type:'image',source:'img/services/img/web-canvas/web-view.png',x:565,y:147,opacity:0}).addLayer({name:'mobile-view',type:'image',source:'img/services/img/web-canvas/mobile-view.png',x:758,y:220,opacity:0}).drawLayers();$(window).scroll(function(){if($(window).scrollTop()>$('#webservices').offset().top-window.innerHeight/2){$('#webservices').animateLayer('base',{y:194,opacity:1},400,function(layer){$(this).animateLayer('computer',{opacity:1,x:211,y:0},400,function(layer){$(this).animateLayer('server',{opacity:1,x:71,y:375,},400);$(this).animateLayer('database',{opacity:1,x:419,y:598,},400);$(this).animateLayer('documents',{opacity:1,x:442,y:558,},400);$(this).animateLayer('keyboard',{opacity:1,x:578,y:429,},400);$(this).animateLayer('mouse',{opacity:1,x:801,y:402,},400);$(this).animateLayer('api',{opacity:1,x:97,y:108},400,function(layer){$(this).animateLayer('admin-view',{opacity:1,x:96,y:392},400);$(this).animateLayer('web-view',{opacity:1,x:436,y:206},400);$(this).animateLayer('mobile-view',{opacity:1,x:758,y:189},400);$(this).animateLayer('line1',{opacity:1},400);$(this).animateLayer('line2',{opacity:1},400);$(this).animateLayer('line3',{opacity:1},400)})})})}})})
/**
...
/* Success story */
$("#success-stories-carousel").on("slid.bs.carousel",function(){var s=$("#success-stories-carousel .item.active").attr("data-activescreen");$(".success-screens-item").removeClass("active"),$("."+s).addClass("active")});